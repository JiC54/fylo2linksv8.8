...
from JiC54.utils.errors import capture_err
from JiC54.utils.functions import make_carbon


@StreamBot.on_message(filters.command("carbon"))
@capture_err
...
@StreamBot.on_message(filters.command("repo"))
