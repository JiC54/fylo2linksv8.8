...
from JiC54 import telethn as bot
from JiC54.utils.urluploader import download_file
from JiC54.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Don't Forget to /donate",
            )
        except Exception as e:
            traceback.print_exc()
